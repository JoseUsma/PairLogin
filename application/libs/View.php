...
class View
{
     ...
     * @param boolean $render_without_header_and_footer Optional: Set this to true if you don't want to include header and footer
     */
    public function pagerender($filename, $render_without_header_and_footer = false)
    {
        // page without header and footer, for whatever reason
        if ($render_without_header_and_footer == true) {
            require VIEWS_PATH . $filename . '.php';
            ...
            require VIEWS_PATH . '_templates/bootheader.php';
            require VIEWS_PATH . '_templates/pageheader.php';
            require VIEWS_PATH . $filename . '.php';
            require VIEWS_PATH . '_templates/bootfooter.php';
        }
    }
    ...
    public function renderFeedbackMessages()
    {
        ...
        require VIEWS_PATH . '_templates/bootfeedback.php';
    ...
    public function renderPageFooter()
    {
        // echo out the feedback messages (errors and success messages etc.),
        // they are in $_SESSION["feedback_positive"] and $_SESSION["feedback_negative"]
        require VIEWS_PATH . '_templates/pagefooter.php';

        // delete these messages (as they are not needed anymore and we want to avoid to show them twice
        Session::set('result_page', null);
    }
    /**
